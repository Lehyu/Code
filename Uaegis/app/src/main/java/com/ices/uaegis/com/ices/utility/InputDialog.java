        ...
        implements View.OnClickListener
{
    ...
    {
        if (paramView.getId() == R.id.c_btn_dialog_ok)
        {
            dismiss();
            onDialogClose(-1);
        }
        while (paramView.getId() != R.id.c_btn_dialog_cancel)
            return;
        dismiss();
        onDialogClose(-2);
    }
    ...
    public void setListener(DialogInterface.OnClickListener paramOnClickListener)
    {
